<template>
    ...
    <el-dialog v-model="dialogFormVisible" width="500">
        ...
        <el-form :model="form" style="margin-top: 15px;" ref="ruleFormRef" :rules="rules">
            ...
            <el-form-item label="课程性质" :label-width="formLabelWidth" prop="quality">
                <el-select
            ...
            <el-form-item label="学分" :label-width="formLabelWidth" prop="points">
                <el-input v-model="form.points" placeholder="请输入课程学分" @input="handleChange2(form.points)" style="width: 280px;" />
            </el-form-item>
            <el-form-item label="总学时" :label-width="formLabelWidth" prop="totalTime">
                <el-input v-model="form.totalTime" placeholder="请输入总学时" @input="handleChange1(form.totalTime)" style="width: 280px;" />
            </el-form-item>
        </el-form>
        <template #footer>
        <div class="dialog-footer">
    ...
    <div class="wholeWrapper">
        ...
        <div class="info-table">
            ...
            <el-table :data="tableData" style="width: 100%;height: calc(100vh - 300px);" :fit="true"  @selection-change="handleSelectionChange" >
                ...
                <el-table-column property="qualityName" label="课程性质"  align="center"/>
                <el-table-column property="typeName" label="课程类别"  align="center"/>
